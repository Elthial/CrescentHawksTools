...
namespace InceptionTools
{
    class GameData
    {
        ...
        List<byte[]> Weapons = new List<byte[]>(){
        ...
        new byte[] {0x4C, 0x52, 0x4D, 0x69, 0x73, 0x73, 0x69, 0x6C, 0x65, 0x35, 0x00, 0x01, 0x04, 0x62, 0xEF, 0x42, 0x03}, //LRMMissile5
        new byte[] {0x4C, 0x52, 0x4D, 0x69, 0x73, 0x73, 0x69, 0x6C, 0x31, 0x30, 0x00, 0x01, 0x06, 0x64, 0xEF, 0x42, 0x03}, //LRMMissile10
        new byte[] {0x4C, 0x52, 0x4D, 0x69, 0x73, 0x73, 0x69, 0x6C, 0x31, 0x35, 0x00, 0x01, 0x07, 0x65, 0xEF, 0x42, 0x03}, //LRMMissile15
        new byte[] {0x4C, 0x52, 0x4D, 0x69, 0x73, 0x73, 0x69, 0x6C, 0x32, 0x30, 0x00, 0x01, 0x08, 0x66, 0xEF, 0x42, 0x03}, //LRMMissile20
        new byte[] {0x53, 0x52, 0x4D, 0x69, 0x73, 0x73, 0x69, 0x6C, 0x65, 0x32, 0x00, 0x02, 0x02, 0x02, 0x87, 0x1E, 0x03}, //SMRMissile2
        new byte[] {0x53, 0x52, 0x4D, 0x69, 0x73, 0x73, 0x69, 0x6C, 0x65, 0x34, 0x00, 0x02, 0x03, 0x03, 0x87, 0x1E, 0x03}, //SRMMissile4
        new byte[] {0x53, 0x52, 0x4D, 0x69, 0x73, 0x73, 0x69, 0x6C, 0x65, 0x36, 0x00, 0x02, 0x05, 0x04, 0x87, 0x1E, 0x03}, //SRMMissile6       
        new byte[] {0x4B, 0x69, 0x63, 0x6B, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x00, 0x00, 0x01, 0x00, 0x21, 0x02, 0x04},  //Kick
       };


        List<byte[]> Mechs = new List<byte[]>() {
